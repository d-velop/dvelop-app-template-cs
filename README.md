...
To develop a d.velop cloud app you will need to install [.NET Core SDK 3.1](https://dotnet.microsoft.com/download/dotnet-core/3.1). Newer versions of the SDK will also work, but keep in mind, that AWS Lambda will only [support LTS versions](https://github.com/aws/aws-lambda-dotnet) of `.NET Core`. 
